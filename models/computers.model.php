...
class ComputersModel
{
    ...
    public function get($id_computadora)
    {
        ...
        $computadora = $sentencia->fetch(PDO::FETCH_OBJ); // obtiene la respuesta
        return $computadora;
    }
    ...
    public function getComputerMarks($marca)
    {
        $db = $this->createConection(); // 1. abro la conexión con MySQL 
        //Creamos la consulta para obtener una categoria
        ...
        WHERE computadora.id_marca = $marca"); // prepara la consulta
